...
namespace MVCSite.DAC.Entities
{
    public partial class TourExclusion
    {
        ...
        {
            if (previousValue != null && previousValue.TourExclusions.Contains(this))
            {
                previousValue.TourExclusions.Remove(this);
            }
    
            if (Tour != null)
            {
                if (!Tour.TourExclusions.Contains(this))
                {
                    Tour.TourExclusions.Add(this);
                }
                if (TourID != Tour.ID)
                {
                    TourID = Tour.ID;
