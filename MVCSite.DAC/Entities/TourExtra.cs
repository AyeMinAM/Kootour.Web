...
namespace MVCSite.DAC.Entities
{
    public partial class TourExtra
    {
        ...
        {
            if (previousValue != null && previousValue.TourExtras.Contains(this))
            {
                previousValue.TourExtras.Remove(this);
            }
    
            if (Tour != null)
            {
                if (!Tour.TourExtras.Contains(this))
                {
                    Tour.TourExtras.Add(this);
                }
                if (TourID != Tour.ID)
                {
                    TourID = Tour.ID;
