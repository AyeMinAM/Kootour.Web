...
namespace MVCSite.DAC.Entities
{
    public partial class TourInclusion
    {
        ...
        {
            if (previousValue != null && previousValue.TourInclusions.Contains(this))
            {
                previousValue.TourInclusions.Remove(this);
            }
    
            if (Tour != null)
            {
                if (!Tour.TourInclusions.Contains(this))
                {
                    Tour.TourInclusions.Add(this);
                }
                if (TourID != Tour.ID)
                {
                    TourID = Tour.ID;
