...
namespace DevTrends.MvcDonutCaching
{
    ...
    {
        protected readonly IKeyGenerator _keyGenerator;
        protected readonly IDonutHoleFiller _donutHoleFiller;
        protected readonly IExtendedOutputCacheManager _outputCacheManager;
        protected readonly ICacheSettingsManager _cacheSettingsManager;
        protected readonly ICacheHeadersHelper _cacheHeadersHelper;

        protected bool? _noStore;
        protected CacheSettings _cacheSettings;
        ...
        {
            //if (_cacheSettings == null)
            //    return;//This is added for AjaxDonutOutputCache.
