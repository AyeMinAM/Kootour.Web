...
{
    public class ObjectCacheManager : IExtendedOutputCacheManager
    {
        ...
        internal ObjectCacheManager(OutputCacheProvider outputCacheProvider, IKeyBuilder keyBuilder)
        {
        ...
        public void AddItem(string controllerName, string actionName, object routeValues,object toCacheObject,int seconds)
        {
            var key = _keyBuilder.BuildKey(controllerName, actionName, new RouteValueDictionary(routeValues));
            _outputCacheProvider.Add(key, toCacheObject, DateTime.Now.AddSeconds(seconds));
        }
        ...
        public object GetItem(string controllerName, string actionName, object routeValues)
        {
            var key = _keyBuilder.BuildKey(controllerName, actionName, new RouteValueDictionary(routeValues));
            return _outputCacheProvider.Get(key);
        }
        /// <summary>
