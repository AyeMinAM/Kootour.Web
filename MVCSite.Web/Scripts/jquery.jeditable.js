...
(function ($) {
    ...
    $.fn.editable = function (target, options) {
        ...
        var beforeclick = settings.beforeclick || function () { };
        /* show tooltip */
        if (settings.tooltip) {
        ...
        return this.each(function () {
            ...
            $(this).bind(settings.event, function (e) {
                beforeclick.apply(self, [self.innerHTML, settings]);
        ...
        $("button:submit", form).bind('click', function () {
            ...
            $.ajaxFileUpload({
                ...
                success: function (data, status) {
                    ...
                    settings.callback.apply(original, [data, settings]);
                },
